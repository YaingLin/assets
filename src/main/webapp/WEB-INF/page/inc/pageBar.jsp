...
<div class="panelBar">
	<div class="pages">
		<span>查到&nbsp;${dwzPageBean.totalCount}&nbsp;条记录，每页</span> <select class="combox" name="numPerPage" value="${dwzPageBean.numPerPage}"
		...
		<span>条，&nbsp;${dwzPageBean.currentPage}/${dwzPageBean.pageCount}&nbsp;页</span>
	</div>
	<div class="pagination" 
		...
		pageNumShown="10" 
		currentPage="${dwzPageBean.currentPage}">
	</div>
</div>