...
<div class="pageContent">
	<form method="post" action="${pageContext.request.contextPath}${requestScope.record ==null ?'/system/organization/insert' :'/system/organization/update' }" class="pageForm required-validate"
		...
		<div class="pageFormContent" layoutH="150">
			...
			<p>
				<label>组织名：</label> <input name="name" class="required" maxlength="50" type="text" value="${requestScope.record.name }" placeholder="组织名" />
			</p>
			<p>
