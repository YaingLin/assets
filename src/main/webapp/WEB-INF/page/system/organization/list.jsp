	...
	<form id="pagerForm" onsubmit="return navTabSearch(this);" action="${pageContext.request.contextPath}/system/organization/list" method="post">
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>组织名：<input type="text" name="name" value="${requestScope.name}" size="30" placeholder="组织名" />
					</td>
				</tr>
			</table>
			<div class="subBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		<shiro:hasPermission name="/system/organization/toInsert">
			<li><a class="add" href="${pageContext.request.contextPath}/system/organization/toInsertRoot" target="ajax" rel="jbsxBox" mask="true" ><span>添加根节点</span></a></li>
			<li><a class="add" onclick="add('${pageContext.request.contextPath}/system/organization/toInsert')" href="javascript:;" mask="true"><span>添加子节点</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="/system/organization/toUpdate">
			<li><a class="edit" onclick="update('${pageContext.request.contextPath}/system/organization/toUpdate')" href="javascript:;" warn="请选择一条记录" mask="true"><span>修改</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="/system/organization/delete">
			<li><a class="delete" onclick="del('${pageContext.request.contextPath}/system/organization/delete')" href="javascript:;" title="确定要删除吗？" warn="请选择一条记录" mask="true"><span>删除</span></a></li>
			<li><a class="delete" href="${pageContext.request.contextPath}/system/organization/delete" target="selectedTodo" rel="id" title="确定要删除吗？" warn="请最小选择一条记录" mask="true"><span>批量删除</span></a></li>
		</shiro:hasPermission>
		</ul>
	</div>
	<div>
