    ...
    <div id="login_content">
        <div class="loginForm">
            <form action="${pageContext.request.contextPath}/login" method="post">
                <p>
                    <label>用户名：</label> <input name="name" value="郭" type="text" style="width: 140px; height: 20px;" class="login_input"/> <br/>
                </p>
                <p>
                    <label>密&nbsp;&nbsp;&nbsp;码：</label> <input name="pwd" type="password" style="width: 140px; height: 20px;" class="login_input" value="123"/> <br/>
                </p>
                <p>
